...
import type {
  ...
  PostApiV2BackupDeleteVersionsData,
  PostApiV2BackupDeleteVersionsResponse,
  PostApiV2BackupListBrokenFilesData,
  PostApiV2BackupListBrokenFilesResponse,
  ...
  PostApiV2BackupSetVersionLabelResponse,
...
export class DuplicatiServer {
   ...
   * @param data The data for the request.
   * @param data.requestBody
   * @returns SetVersionLabelResponseDto OK
   * @throws ApiError
   */
  public postApiV2BackupSetVersionLabel(
    data: PostApiV2BackupSetVersionLabelData
  ): Observable<PostApiV2BackupSetVersionLabelResponse> {
    return __request(OpenAPI, this.http, {
      method: 'POST',
