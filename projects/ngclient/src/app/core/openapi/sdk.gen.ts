...
export class DuplicatiServer {
     ...
     * @param data The data for the request.
     * @param data.taskid
     * @param data.alsoTransfers
     * @returns unknown OK
     * @throws ApiError
     */
    public postApiV1TaskByTaskidPause(data: PostApiV1TaskByTaskidPauseData): Observable<PostApiV1TaskByTaskidPauseResponse> {
        return __request(OpenAPI, this.http, {
            method: 'POST',
            url: '/api/v1/task/{taskid}/pause',
            path: {
                taskid: data.taskid
            },
            query: {
                alsoTransfers: data.alsoTransfers
            }
        });
    }
     ...
     * @throws ApiError
     */
    public postApiV1TaskByTaskidResume(data: PostApiV1TaskByTaskidResumeData): Observable<PostApiV1TaskByTaskidResumeResponse> {
        return __request(OpenAPI, this.http, {
            method: 'POST',
            url: '/api/v1/task/{taskid}/resume',
            path: {
                taskid: data.taskid
            }
        });
